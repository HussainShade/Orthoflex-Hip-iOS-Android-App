...
class AddScore3Vc: UIViewController {
    ...
    @IBAction func DoctorAddPatientAddSaveScore(_ sender: Any) {
...
extension AddScore3Vc: UITableViewDelegate,UITableViewDataSource {

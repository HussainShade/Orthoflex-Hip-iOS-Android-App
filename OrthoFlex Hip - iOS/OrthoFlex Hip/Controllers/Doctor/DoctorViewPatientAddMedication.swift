//
//  DoctorViewPatientAddMedication.swift
//  OrthoFlex Hip
//
...
class DoctorViewPatientAddMedication: UIViewController {
                    ...
                    self?.dismiss(animated: false, completion: nil)
                        ...
                        alertController.addAction(cancelAction)
                         self?.present(alertController, animated: true, completion: nil)
                             ...
                             DataManager.shared.sendMessage(title: "Alert", message: data.message, navigation: (self?.navigationController)!)
                         }
                     }
...
extension DoctorViewPatientAddMedication: UITableViewDelegate,UITableViewDataSource {
